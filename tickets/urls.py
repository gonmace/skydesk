...
urlpatterns = [
    ...
    path('<int:pk>/eliminar/', views.ticket_delete, name='delete'),
    path('etiquetas/', views.labels_manage, name='labels'),
    path('etiquetas/agregar/', views.label_quick_add, name='label_add'),
    ...
    path('adjunto/<int:pk>/anotar/', views.attachment_annotate, name='attachment_annotate'),
